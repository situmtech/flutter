 ...
 * should consider using a regular {@link FlutterFragmentActivity} instead, because {@link FlutterFragmentActivity}
 * is considered to be the standard, canonical implementation of a Flutter {@code FragmentActivity}.
 */
...
public class FlutterAppCompatActivity extends AppCompatActivity
     ...
     * a new {@link FlutterEngine} using the desired Dart entrypoint,
     * initial route, etc.
     */
    @NonNull
    ...
    public static class CachedEngineIntentBuilder {
        ...
        /**
         * Returns true if the cached {@link FlutterEngine} should be
    ...
    /**
     * Returns false if the {@link FlutterEngine} backing this {@code
     ...
     * own {@link FlutterEngine}, and {@code false} in cases where a
     * cached {@link FlutterEngine} was provided.
     */
     ...
     * Activity} automatically attaches its {@link FlutterEngine} to this
     * {@code Activity}.
     *
    ...
    /**
     * Returns the ID of a statically cached {@link FlutterEngine} to use
